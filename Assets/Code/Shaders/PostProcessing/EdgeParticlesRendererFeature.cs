...
public sealed class EdgeParticlesRendererFeature : ScriptableRendererFeature
{
    ...
    public override void AddRenderPasses(ScriptableRenderer renderer, ref RenderingData renderingData)
    {
        ...
        EdgeParticlesVolumeComponent myVolume = VolumeManager.instance.stack?.GetComponent<EdgeParticlesVolumeComponent>();
    ...
    private class CustomPostRenderPass : ScriptableRenderPass
    {
        ...
        private static void ExecuteMainPass(RasterCommandBuffer cmd, RTHandle sourceTexture, Material material)
        {
            ...
            if (myVolume != null)
            {
                ...
                s_SharedPropertyBlock.SetColor("_Color", myVolume.color.value);
                s_SharedPropertyBlock.SetFloat("_ParticleSize", myVolume.particleSize.value);
                s_SharedPropertyBlock.SetFloat("_ParticleDensity", myVolume.particleDensity.value);
                s_SharedPropertyBlock.SetFloat("_ParticleSpeed", myVolume.particleSpeed.value);
                s_SharedPropertyBlock.SetFloat("_MaskSize", myVolume.maskSize.value);
                s_SharedPropertyBlock.SetFloat("_MaskSoftness", myVolume.maskSoftness.value);
            }
