...
[VolumeComponentMenu("Post-processing Custom/EdgeParticles")]

// If the related Scriptable Renderer Feature doesn't exist, display a warning about adding it to the renderer.
[VolumeRequiresRendererFeatures(typeof(EdgeParticlesRendererFeature))]
...
public sealed class EdgeParticlesVolumeComponent : VolumeComponent, IPostProcessComponent
{
    // Set the name of the volume component in the list in the Volume Profile.
    public EdgeParticlesVolumeComponent()
    {
        displayName = "EdgeParticles";
    }
